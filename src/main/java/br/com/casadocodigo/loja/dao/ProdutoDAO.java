...
public class ProdutoDAO {
	...
	public List<Produto> listarPorData(Calendar data) {
		return manager.createQuery("select distinct(p) from Produto p join fetch p.precos where p.dataLancamento >= :dataLancamento", Produto.class)
